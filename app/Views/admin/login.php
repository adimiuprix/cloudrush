...
<html
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url('public/admin/vendor/css/core.css'); ?>" />
        <link rel="stylesheet" href="<?= base_url('public/admin/vendor/css/theme-default.css'); ?>" />
        ...
        <link rel="stylesheet" href="<?= base_url('public/admin/vendor/css/pages/page-auth.css'); ?>" />
                ...
                <div class="authentication-inner py-6 mx-4">
                    ...
                    <div class="card p-7">
                        ...
                        <div class="card-body mt-1">
                            ...
                            <p class="mb-5">Please sign-in to main panel administrator</p>
                            <form id="formAuthentication" class="mb-5" action="<?= base_url('admin/session-check');?>" method="POST">
                    ...
                    <!-- /Login -->
                    <img
                        src="<?= base_url('public/admin/img/illustrations/tree-3.png'); ?>"
                        alt="auth-tree"
                        class="authentication-image-object-left d-none d-lg-block" />
                    <img
                        src="<?= base_url('public/admin/img/illustrations/auth-basic-mask-light.png'); ?>"
                    ...
                    <img
                        src="<?= base_url('public/admin/img/illustrations/tree.png'); ?>"
                        alt="auth-tree"
