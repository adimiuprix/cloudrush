<div class="row text-uppercase mb-4">
    ...
    <div class="col-md-6 col-lg-3">
        <div class="st">
            <div class="pulse-st2"></div>
            <div class="stat2"> <b class="st-count"><?= esc($web_stats['total_deposit']); ?> <small class="notranslate">TRX</small> </b></div>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="st">
            <div class="pulse-st2"></div>
            <div class="stat2"> <b class="st-count"><?= esc($web_stats['total_withdraw']); ?> <small class="notranslate">TRX</small> </b></div>
